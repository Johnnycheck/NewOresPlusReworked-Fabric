...
public class ModConfiguredFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> ENDSTONE_SAPPHIRE_ORE_KEY = registerKey("endstone_sapphire_ore");
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ENDSTONE_SAPPHIRE_ORE_KEY, Feature.ORE, new OreFeatureConfig(endSapphireOres, 12));
    }
